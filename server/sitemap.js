...
exports.sitemapStructure = () => {
  ...
  return {
    ...
    map: {
      ...
      '/signup': ['get'],
      '/login': ['get'],
      '/s?address=NewYork%2C%20Finland%26bounds=60.2978389%2C25.254484899999966%2C59.9224887%2C24.782875800000056%26country=FI%26origin=60.16985569999999%2C24.93837910000002': [
        'get',
      ],
      '/account': ['get'],
      '/reset-password': ['get'],
